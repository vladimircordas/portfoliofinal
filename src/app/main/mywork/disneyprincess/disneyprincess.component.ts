...
@Component({
  selector: 'app-disneyprincess',
  templateUrl: './disneyprincess.component.html',
  styleUrls: ['./disneyprincess.component.scss']
})
export class DisneyprincessComponent implements OnInit {
